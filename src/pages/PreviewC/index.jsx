...
function PreviewC() {
  ...
  return (
    <div className={styles.preview} data-aos="fade-up"> {/* Yangi animatsiya */}
      <div className="container">
        <div className={styles.one} data-aos="fade-up"> {/* Yangi animatsiya */}
        ...
        <div className={styles.two} data-aos="fade-up"> {/* Yangi animatsiya */}
        ...
        <div className={styles.four} data-aos="fade-up"> {/* Yangi animatsiya */}
        ...
        <div className={styles.five} data-aos="fade-up"> {/* Yangi animatsiya */}
